...
namespace ProjeYonetim.Data.Concrete.EFCore
{
    public class SeedDatabase
    {
        private static readonly Employee[] Employees =
        {
            ...
            new Employee() {IsActive=true, FullName = "Eyüp Orhun Fındık", Gender = Gender.Erkek, DateOfBirth = new DateTime(1975, 2, 2), Department = Department.Yönetim, Salary = 10000, LastUpdateDate = DateTime.Now.Date },
            new Employee() {IsActive=true, FullName = "Nergiz Gilim", Gender = Gender.Kadın, DateOfBirth = new DateTime(1975, 3, 3), Department = Department.Muhasebe, Salary = 3000, LastUpdateDate = DateTime.Now.Date },
            new Employee() {IsActive=true, FullName = "Kubra Göçmen", Gender = Gender.Kadın, DateOfBirth = new DateTime(1985, 4, 4), Department = Department.Muhasebe, Salary = 4000, LastUpdateDate = DateTime.Now.Date },
            new Employee() {IsActive=true, FullName = "Berhudan Garip", Gender = Gender.Kadın, DateOfBirth = new DateTime(1975, 5, 5), Department = Department.Muhasebe, Salary = 2000, LastUpdateDate = DateTime.Now.Date },
            new Employee() {IsActive=true, FullName = "Nihan Gazitepe", Gender = Gender.Kadın, DateOfBirth = new DateTime(1993, 6, 6), Department = Department.Satış, Salary = 7000, LastUpdateDate = DateTime.Now.Date },
            new Employee() {IsActive=true, FullName = "Menekşe Geben", Gender = Gender.Kadın, DateOfBirth = new DateTime(1975, 7, 7), Department = Department.Satış, Salary = 3000, LastUpdateDate = DateTime.Now.Date },
            new Employee() {IsActive=true, FullName = "Şeniz Geboloğlu", Gender = Gender.Erkek, DateOfBirth = new DateTime(1985, 8, 8), Department = Department.Satış, Salary = 3000, LastUpdateDate = DateTime.Now.Date },
            new Employee() {IsActive=true, FullName = "Zeynep Senahan Geçioğlu", Gender = Gender.Kadın, DateOfBirth = new DateTime(1993, 9, 9), Department = Department.Satış, Salary = 6000, LastUpdateDate = DateTime.Now.Date },
            new Employee() {IsActive=true, FullName = "Hayri Anıl Geçkin", Gender = Gender.Erkek, DateOfBirth = new DateTime(1993, 1, 10), Department = Department.Satış, Salary = 5000, LastUpdateDate = DateTime.Now.Date },
            new Employee() {IsActive=true, FullName = "Muazzez Ece Gemalmaz", Gender = Gender.Kadın, DateOfBirth = new DateTime(1985, 2, 11), Department = Department.Satış, Salary = 4000, LastUpdateDate = DateTime.Now.Date},
            new Employee() {IsActive=true, FullName = "Kerem Cahit Gençoğlu", Gender = Gender.Erkek, DateOfBirth = new DateTime(1991, 3, 12), Department = Department.Yazılım, Salary = 3000, LastUpdateDate = DateTime.Now.Date },
            new Employee() {IsActive=true, FullName = "Sadık Can Gezmiş", Gender = Gender.Erkek, DateOfBirth = new DateTime(1975, 4, 13), Department = Department.Yazılım, Salary = 6000, LastUpdateDate = DateTime.Now.Date },
            new Employee() {IsActive=true, FullName = "Resmiye Elif Gırgın", Gender = Gender.Kadın, DateOfBirth = new DateTime(1985, 5, 14), Department = Department.Yazılım, Salary = 5000, LastUpdateDate = DateTime.Now.Date },
            new Employee() {IsActive=true, FullName = "İrfan Anıl Fındıkçı", Gender = Gender.Erkek, DateOfBirth = new DateTime(1975, 6, 15), Department = Department.Yazılım, Salary = 4000, LastUpdateDate = DateTime.Now.Date },
            new Employee() {IsActive=true, FullName = "Mehmet Gökalp Ginoviç", Gender = Gender.Erkek, DateOfBirth = new DateTime(1993, 7, 16), Department = Department.Yazılım, Salary = 5000, LastUpdateDate = DateTime.Now.Date },
            new Employee() {IsActive=true, FullName = "Mehmetali Girgin", Gender = Gender.Erkek, DateOfBirth = new DateTime(1975, 8, 17), Department = Department.Yazılım, Salary = 5000, LastUpdateDate = DateTime.Now.Date },
            new Employee() {IsActive=true, FullName = "Abdullah Halit Golba", Gender = Gender.Erkek, DateOfBirth = new DateTime(1985, 9, 18), Department = Department.Yazılım, Salary = 6000, LastUpdateDate = DateTime.Now.Date },
            new Employee() {IsActive=true, FullName = "Tilbe Göç", Gender = Gender.Kadın, DateOfBirth = new DateTime(1991, 1, 19), Department = Department.Yazılım, Salary = 4000, LastUpdateDate = DateTime.Now.Date },
            new Employee() {IsActive=true, FullName = "Ertuğ Furuncuoğlu", Gender = Gender.Erkek, DateOfBirth = new DateTime(1985, 2, 21), Department = Department.Yazılım, Salary = 5000, LastUpdateDate = DateTime.Now.Date },
            new Employee() {IsActive=true, FullName = "Kubilay Gödek", Gender = Gender.Erkek, DateOfBirth = new DateTime(1975, 3, 22), Department = Department.Yazılım, Salary = 4000, LastUpdateDate = DateTime.Now.Date },
            new Employee() {IsActive=true, FullName = "Busem Gökçeaslan", Gender = Gender.Kadın, DateOfBirth = new DateTime(1993, 4, 23), Department = Department.Yazılım, Salary = 4000, LastUpdateDate = DateTime.Now.Date },
            new Employee() {IsActive=true, FullName = "Banuhan Gökçek", Gender = Gender.Kadın, DateOfBirth = new DateTime(1975, 5, 24), Department = Department.Yazılım, Salary = 6000, LastUpdateDate = DateTime.Now.Date },
            new Employee() {IsActive=true, FullName = "Örgün Gökhan", Gender = Gender.Erkek, DateOfBirth = new DateTime(1985, 6, 25), Department = Department.Yazılım, Salary = 5000, LastUpdateDate = DateTime.Now.Date },
            new Employee() {IsActive=true, FullName = "Melike Göksoy", Gender = Gender.Kadın, DateOfBirth = new DateTime(1993, 7, 26), Department = Department.Satış, Salary = 3000, LastUpdateDate = DateTime.Now.Date },
            new Employee() {IsActive=true, FullName = "Yeşim Gölmes", Gender = Gender.Kadın, DateOfBirth = new DateTime(1985, 8, 27), Department = Department.Satış, Salary = 7000, LastUpdateDate = DateTime.Now.Date },
            new Employee() {IsActive=true, FullName = "Nilüfer Gönay", Gender = Gender.Kadın, DateOfBirth = new DateTime(1993, 9, 28), Department = Department.Satış, Salary = 7000, LastUpdateDate = DateTime.Now.Date }
        };
